...
<h1>Homeless Animal platform</h1>
</div>
</div>
</div>
<div id='sub-header'>
...
Tel：${animal.shelter_tel}。<p>
<br/>
<div class="separator" style="clear: both; text-align: center;">
<a href="" imageanchor="1" style="clear: left; float: left; margin-bottom: 1em; margin-right: 1em;"><img border="0" height="320" src="${animal.album_file}" width="229"></a></div>
info：${animal.animal_remark}<br/>
<br />
<div>
<br /></div>
</div>
